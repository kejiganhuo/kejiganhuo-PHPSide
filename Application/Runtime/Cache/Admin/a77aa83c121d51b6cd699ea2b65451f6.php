            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="type" id="optionsRadiosInline1" value="1" <?php if($menus["type"] == 1): ?>checked<?php endif; ?>> 后台菜单
                            <input type="radio" name="type" id="optionsRadiosInline2" value="0" <?php if($menus["type"] == 0): ?>checked<?php endif; ?>> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" id="inputPassword3" placeholder="模块名如admin" value="<?php echo ($menus["m"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
